                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('question.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" rows="4" name="pertanyaan" rows={{ old('pertanyaan') }}></textarea>
                            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <h1 class="display-5 fw-bold font-custom">Judul dengan Font Custom</h1>
                        <p class="font-custom">Paragraf ini memakai Flavors-Regular.</p>
                    </div>
                </div>
            </div>
        </div>
